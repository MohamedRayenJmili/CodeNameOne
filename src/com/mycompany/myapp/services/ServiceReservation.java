...
public class ServiceReservation{
    ...
    //ajout 
    public void ajoutReservation(Reservation t) {
        
      String  client ="2";
        String url =Statics.BASE_URL+"AddReservationJSON?nbPlaces="+t.getNbplaces()+"&idEvent="+t.getEv().getId()+"&client="+client;
...
//Date 
    ...
    //Update 
    public boolean modifierReservation (Reservation  t) {
        String url = Statics.BASE_URL +"UpdateReservationJSON/"+t.getId()+"?&nbPlaces="+t.getNbplaces();
        req.setUrl(url);
