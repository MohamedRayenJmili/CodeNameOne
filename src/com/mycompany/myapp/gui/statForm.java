 ...
 */
    ...
    List<datas> Form = new ArrayList<>();
     ArrayList<Evenement> tsk=ServiceEvenement.getInstance().affichageEvenement();
         
         for(Evenement form :tsk)
         {
     Form.add(new datas(0,  form.getId(),form.getTitreEv(),0));
         }
         for(datas stat :Form)
         {
             int t=0;
          for(Evenement abo :tsk)
          {
