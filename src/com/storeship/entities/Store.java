...
public class Store {
    ...
    private Categorie_store categorie;

    public Categorie_store getCategorie() {
        return categorie;
    }

    public void setCategorie(Categorie_store categorie) {
    ...
    public Store(int id, String nameSt, String location, User owner, String photo, float rating,Categorie_store categorie) {
        this.id = id;
        this.nameSt = nameSt;
